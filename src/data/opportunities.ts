...
export const opportunityDetails: Record<string, OpportunityDetail> = {
  ...
  'An Underworld Connection?': {
    ...
    aspects: 'Moth 8, Knock 6, Edge 8, Asset, Connection, Assists Deception. Operations: [[Compete in Illegal Fights]] (+ Stolen Year), [[Counterfeiting Operation]] (+ 6 Forge, 2 Space), [[Smuggling Operation]] (+ Sea, 2 Space). Defends Assets against theft',
  },
  ...
  'Medical Credentials?': {
    ...
    aspects: 'Worth 1, Proof, Portable, Asset. Combine with Space + a Stolen Year to run a [[Medical Practice]] (1 Comfort) or a [[Run a Sanatorium]] (2 Space, 4 Comfort). Stolen Year is consumed; Credentials and Space are returned',
  },
